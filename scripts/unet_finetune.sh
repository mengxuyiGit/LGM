...
accelerate launch --main_process_port 29518 --config_file acc_configs/gpu6.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_unet_accumulate_shared.py big \
    ...
    --desc 'train_unet-fted_LGM_fov60-resume103k' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
    ...
    --resume_unet /mnt/kostas_home/lilym/LGM/LGM/runs/finetune_unet/workspace_train_july/00001-train_unet-fted_LGM_fov60-resume100k-train_unet-loss-lr4e-06-Plat50/eval_global_step_3000_ckpt/model.safetensors
