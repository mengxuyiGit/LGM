...
#     --scene_start_index 1750 --scene_end_index 2000 --early_stopping \
#     --resume_workspace 'runs/LGM_optimize_splatter/shapenet_fit_batch/00007-debug_srn_cars-es10-Plat-patience_10-factor_0.5-eval_150-adamW-subset_1750_2000_splat128-inV6-lossV20-lr0.006/cars_train'
...
accelerate launch --config_file acc_configs/gpu1.yaml main_pretrained_batch_srn_cars.py big --workspace runs/LGM_optimize_splatter/optimize \
    ...
    --resume_workspace '/home/xuyimeng/Repo/LGM/runs/LGM_optimize_splatter/shapenet_fit_batch/00007-debug_srn_cars-es10-Plat-patience_10-factor_0.5-eval_150-adamW-subset_1750_2000_splat128-inV6-lossV20-lr0.006'