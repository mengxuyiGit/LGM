...
#     --desc 'discriminator_acc64' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K_CLUSTER} \
...
#     --bg 1.0 --fovy 60 \
#     --finetune_decoder \
#     --batch_size 1 --num_workers 1 --gradient_accumulation_steps 64 \
#     --use_video_decoderST \
...
accelerate launch --main_process_port 29516 --config_file acc_configs/gpu2.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_accumulate_ddp.py big \
    ...
    --desc 'discriminator_ddp_acc6' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
    --data_path_vae_splatter ${DATA_DIR_BATCH_LVIS_SPLATTERS_MV_ROOT_FINETUNED_CLUSTER} \
    --set_random_seed \
    --model_type Zero123PlusGaussianMarigoldUnetCrossDomain \
    --custom_pipeline "./zero123plus/pipeline_v8_cat.py" --render_input_views --attr_group_mode "v5" \
    --bg 1.0 --fovy 60 \
    --finetune_decoder \
    --batch_size 1 --num_workers 1 --gradient_accumulation_steps 6 \
    --use_video_decoderST \
    --disc_conditional --disc_factor 1.0 --discriminator_warm_up_steps 100 --lambda_discriminator 1.0 \
    --invalid_list /mnt/kostas_home/lilym/LGM/LGM/data_lists/lvis_invalid_uids_nineviews.json \
    --resume_decoder /mnt/kostas_home/lilym/LGM/LGM/runs/finetune_decoder/workspace_train_july/20240708-050809-svd-decoder-fted_lgm-resume6k-loss_render1.0_splatter2.0_lpips2.0-lr0.0001-Plat5/eval_global_step_30000_ckpt/model.safetensors