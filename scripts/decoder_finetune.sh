...
accelerate launch --main_process_port 29514 --config_file acc_configs/gpu2.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_accumulate.py big \
    --workspace runs/finetune_decoder/workspace_overfit \
    ...
    --desc 'LARA_DATA-sd_decoder-2dgs-scale_0-with_clip-decoded-OVERFIT-2GPUS' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
