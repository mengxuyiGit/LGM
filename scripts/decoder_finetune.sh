...
accelerate launch --main_process_port 29516 --config_file acc_configs/gpu1.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_accumulate.py big \
    ...
    --desc 'svd-decoder-fted_lgm-resume6k' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K_CLUSTER} \
    ...
    --bg 1.0 --fovy 60 \
    --finetune_decoder \
    --batch_size 1 --num_workers 1 --gradient_accumulation_steps 16 \
    --use_video_decoderST \
    --invalid_list /mnt/kostas_home/lilym/LGM/LGM/data_lists/lvis_invalid_uids_nineviews.json \
    --resume_decoder /mnt/kostas_home/lilym/LGM/LGM/runs/finetune_decoder/workspace_train_july/20240707-025251-svd-decoder-fted_lgm-resume1k-loss_render5.0_splatter1.0_lpips5.0-lr1e-06-Plat5/eval_global_step_5000_ckpt/model.safetensors