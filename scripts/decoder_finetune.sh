...
DATA_DIR_BATCH_LVIS_SPLATTERS_MV_ROOT=/mnt/kostas-graid/sw/envs/xuyimeng/Repo/zero-1-to-G/runs/lvis/data_processing/testing

accelerate launch --main_process_port 29514 --config_file acc_configs/gpu6.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_accumulate.py big \
    ...
    --desc '6gpus_bsz2_accumulate20' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
    ...
    --finetune_decoder --gradient_accumulation_steps 20 --output_size 320
...
#     --custom_pipeline "./zero123plus/pipeline_v7_seq.py" --render_input_views --attr_group_mode "v5" \
#     --bg 1.0 --fovy 50 --only_train_attention --rendering_loss_use_weight_t \
#     --finetune_decoder --gradient_accumulation_steps 20 --output_size 320 --skip_training
