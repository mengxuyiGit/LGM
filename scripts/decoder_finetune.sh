...
#     --lambda_splatter 50 --lambda_rendering 1 --lambda_alpha 0 --lambda_lpips 1 \
#     --desc 'resume_decoder_w_splatter_loss_4gpus_bsz2_accumulate32' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
...
#     --resume_decoder /mnt/kostas-graid/sw/envs/xuyimeng/Repo/LGM/runs/finetune_decoder/workspace_train/00003-4gpus_bsz2_accumulate32-sp_guide_1-codes_from_encoder-v0_unfreeze_all-pred128_last_layer-skip_predict_x0-loss_render1.0_lpips1.0-lr0.0001-Plat50/eval_global_step_1100_ckpt/model.safetensors
