...
accelerate launch --config_file acc_configs/gpu8.yaml main_zero123plus_v4_batch_code.py big --workspace runs/zerp123plus_batch/workspace_train \
    ...
    --desc 'only_decoder_8gpus' --data_path_rendering ${DATA_DIR_BATCH_RENDERING} --data_path_splatter_gt ${DATA_DIR_BATCH_SPLATTER_GT_ROOT} \
