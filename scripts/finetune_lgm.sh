...
accelerate launch --config_file acc_configs/gpu1.yaml main1_lvis.py big --workspace runs/finetune_lgm/workspace_ovft \
    ...
    --prob_cam_jitter 0 \
    --num_input_views 6 \
    --lambda_normal_err 0.01 --lambda_normal 0.2 --lambda_depth 0.5 --normal_depth_begin_iter 500 --resume_iter 0 \
    --batch_size 1 --gradient_accumulation_steps 1 --overfit_one_scene --desc "detach-splatter_128-normal_loss_0.2_depth_0.5_after500-normal_err_after7k"
