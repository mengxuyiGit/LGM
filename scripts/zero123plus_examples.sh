...
# accelerate launch --main_process_port 29519 --config_file acc_configs/gpu2.yaml main_zero123plus_v5_batch_marigold_finetune_0123++_low_res.py big \
#     --workspace runs/finetune_0123++/workspace_train_aug \
...
#     --desc '6_views-ONLY_image_NumAttr1_320-with_temporal_attn-b4_g2_acc1' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
...
#     --batch_size 4 --num_workers 1 --gradient_accumulation_steps 1 \
...
accelerate launch --main_process_port 29518 --config_file acc_configs/gpu1.yaml main_zero123plus_v5_batch_marigold_finetune_0123++_inference_GSO.py big \
    ...
    --prob_cam_jitter 0 --input_size 320 --output_size 320 --num_input_views 6 --num_views 6 \
    --lambda_splatter 0 --lambda_rendering 0 --lambda_alpha 0 --lambda_lpips 0 --lambda_splatter_lpips 0 \
    --desc 'mask&image320-WITH_TEMPORAL_ATTN-Num2attr-checkClassEmb-7k-6views-inference-2k-encode_decode_rgb320' --data_path_rendering ${DATA_RENDERING_ROOT_GSO} --metric_GSO \
    --data_path_vae_splatter ${DATA_DIR_BATCH_LVIS_SPLATTERS_MV_ROOT} \
    --set_random_seed \
    --model_type Zero123PlusLowRes \
    --custom_pipeline "./zero123plus/pipeline_v8_cat.py" --render_input_views --attr_group_mode "v5" \
    ...
    --invalid_list /mnt/kostas_home/lilym/LGM/LGM/data_lists/lvis_invalid_uids_nineviews.json \
    --train_unet_single_attr input masks_input \
    --resume_unet '/mnt/kostas_home/lilym/LGM/LGM/runs/finetune_0123++/workspace_train_aug/00002-6_views-WITH_temporal_attn-mask&image_NumAttr2_320-4views-res320-b3_g2_acc1-train_unet-numV6-loss-lr1e-05-Plat50/eval_global_step_7000_ckpt/model.safetensors'
    # --resume_unet '/mnt/kostas_home/lilym/LGM/LGM/runs/finetune_0123++/workspace_train_aug/00000-scaled_class_emb10-WITH_temporal_attn-mask&image_NumAttr2_320-4views-res320-b3_g2_acc1-train_unet-numV4-loss-lr1e-05-Plat50/eval_global_step_7000_ckpt/model.safetensors'
    # --resume_unet '/mnt/kostas_home/lilym/LGM/LGM/runs/finetune_0123++/workspace_train_july/00005-mask&image_NumAttr2_320-4views-res320-b3_g4_acc2-train_unet-numV4-loss-lr1e-05-Plat50/eval_global_step_10000_ckpt/model.safetensors'
    # --resume_unet '/mnt/kostas_home/lilym/LGM/LGM/runs/finetune_0123++/workspace_train_july/00006-no_temporal_attn-mask&image_NumAttr2_320-4views-res320-b3_g4_acc2-train_unet-numV4-loss-lr1e-05-Plat50/eval_global_step_16000_ckpt/model.safetensors'
