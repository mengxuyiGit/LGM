...
accelerate launch --config_file acc_configs/gpu1.yaml main_pretrained_batch_srn_cars.py big --workspace runs/LGM_optimize_splatter/optimize \
    ...
    --resume_workspace '/home/xuyimeng/Repo/LGM/runs/LGM_optimize_splatter/shapenet_fit_batch/00004-debug_srn_cars-es10-Plat-patience_10-factor_0.5-eval_150-adamW-subset_1000_1250_splat128-inV6-lossV20-lr0.006'
