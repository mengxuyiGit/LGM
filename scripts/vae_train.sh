...
VAE_CKPT="/home/xuyimeng/Repo/LGM/runs/vae_train/workspace_train/00004-ddp_srn-sp_guide_1-codes_from_encoder-v0_unfreeze_all-pred128_last_layer-skip_predict_x0-loss_render1.0_splatter1.0_lpips1.0_kl1e-06-lr0.0001-Plat100/model.safetensors"
# [TRAIN VAE]
...
accelerate launch --main_process_port 29510 --config_file acc_configs/gpu2.yaml main_zero123plus_v4_batch_vae.py big --workspace runs/vae_train/workspace_train \
    ...
    --prob_cam_jitter 0 --prob_grid_distortion 0 --input_size 320 --num_input_views 6 --num_views 20 \
    --lambda_splatter 1 --lambda_rendering 1 --lambda_alpha 0 --lambda_lpips 1 \
    --desc 'ddp_srn_resume00004' --data_path_rendering ${DATA_DIR_BATCH_RENDERING_SRN} --data_path_splatter_gt ${DATA_DIR_BATCH_SPLATTER_GT_ROOT_SRN_HQ} \
    --set_random_seed --batch_size 1 --num_workers 1 --plot_attribute_histgram 'scale' \
    --skip_predict_x0 --scale_act 'biased_softplus' --scale_act_bias -3 --scale_bias_learnable \
    --model_type Zero123PlusGaussianVaeKL \
    --splatter_guidance_interval 1 --save_train_pred -1 --decode_splatter_to_128 \
    --decoder_upblocks_interpolate_mode "last_layer" --codes_from_encoder \
    --lambda_kl 1e-6 --data_mode srn_cars --save_ckpt_copies --output_size 128 --resume ${VAE_CKPT}
...
# # ## 1GPUs, W/ rendering loss
# accelerate launch --main_process_port 29512 --config_file acc_configs/gpu2.yaml main_zero123plus_v4_batch_code_unet_rendering_loss.py big --workspace runs/vae_train/workspace_unet \
#     --lr 1e-5 --num_epochs 1001 --eval_iter 5 --save_iter 10 --lr_scheduler Plat \
...
#     --desc 'srn-unet-from-trained-vae-2gpus-unet-w-rendering-loss' --data_path_rendering ${DATA_DIR_BATCH_RENDERING_SRN} --data_path_splatter_gt ${DATA_DIR_BATCH_SPLATTER_GT_ROOT_SRN_HQ} \
#     --set_random_seed --batch_size 1 --num_workers 0 --plot_attribute_histgram 'scale' \
#     --skip_predict_x0 --scale_act 'biased_softplus' --scale_act_bias -3 --scale_bias_learnable \
#     --scale_clamp_max -2 --scale_clamp_min -10 --model_type Zero123PlusGaussianCodeUnet \
#     --splatter_guidance_interval 1 --save_train_pred -1 --decode_splatter_to_128 \
#     --decoder_upblocks_interpolate_mode "last_layer" \
#     --resume ${VAE_CKPT} --codes_from_encoder --output_size 128 --data_mode "srn_cars" 
    
    # --overfit_one_scene

# # ## 1GPUs, W/O rendering loss
# accelerate launch --config_file acc_configs/gpu1.yaml main_zero123plus_v4_batch_code_unet.py big --workspace runs/srn_vae/workspace_debug \
#     --lr 1e-5 --num_epochs 10001 --eval_iter 20 --save_iter 20 --lr_scheduler Plat \
#     --lr_scheduler_patience 5 --lr_scheduler_factor 0.7 --lr_schedule_by_train \
#     --prob_cam_jitter 0 --input_size 320 --num_input_views 6 --num_views 16 \
#     --lambda_splatter 1 --lambda_rendering 1 --lambda_alpha 0 --lambda_lpips 0   \
#     --desc 'srn-unet-from-trained-vae-1gpus-unet-w-rendering-loss' --data_path_rendering ${DATA_DIR_BATCH_RENDERING} --data_path_splatter_gt ${DATA_DIR_BATCH_SPLATTER_GT_ROOT} \
#     --set_random_seed --batch_size 1 --num_workers 1 --plot_attribute_histgram 'scale' \
#     --skip_predict_x0 --scale_act 'biased_softplus' --scale_act_bias -3 --scale_bias_learnable \
#     --scale_clamp_max -2 --scale_clamp_min -10 --model_type Zero123PlusGaussianCodeUnet \
#     --splatter_guidance_interval 1 --save_train_pred -1 --decode_splatter_to_128 \
#     --decoder_upblocks_interpolate_mode "last_layer" \
#     --resume ${VAE_CKPT} --codes_from_encoder 
