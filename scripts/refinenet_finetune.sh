...
accelerate launch --main_process_port 29516 --config_file acc_configs/gpu4.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_unet_accumulate_shared.py big \
    --workspace runs/finetune_refinenet/workspace_train_june \
    --lr 2e-6 --max_train_steps 100000 --eval_iter 50 --save_iter 500 --lr_scheduler Plat \
    ...
    --desc 'refinement_input_3choices-batch_denoise' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
