...
accelerate launch --main_process_port 29517 --config_file acc_configs/gpu2.yaml main_zero123plus_v5_batch_marigold_finetune_decoder_unet_accumulate_shared.py big \
    --workspace runs/finetune_refinenet/workspace_debug \
    --lr 1e-5 --max_train_steps 100000 --eval_iter 1000 --save_iter 1000 --lr_scheduler Plat \
    ...
    --desc 'offset_all_attr-grid_size32-high_lpips-bsz16' --data_path_rendering ${DATA_RENDERING_ROOT_LVIS_46K} \
    ...
    --drop_cond_prob 0.1 --refinement_network ptv3 --refinement_input \
    --batch_size 4 --num_workers 1 --gradient_accumulation_steps 2 
