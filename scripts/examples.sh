...
accelerate launch --config_file acc_configs/gpu1.yaml main_pretrained_batch.py big \
    ...
    --scene_start_index 150 --scene_end_index 250 --early_stopping 
    # --resume_workspace 'runs/LGM_optimize_splatter/workspace_debug_batch_subset_es/00000-batch-es10-Plat-patience_2-factor_0.5-eval_5-adamW-subset_10_250_splat128-inV6-lossV20-lr0.003'
