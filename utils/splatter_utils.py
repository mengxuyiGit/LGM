...
def load_splatter_mv_ply_as_dict(splatter_dir, device="cpu", range_01=False, use_2dgs=True, selected_attr_list=None, return_gassians=False):
...
def load_splatter_mv_ply_as_dict_debug(splatter_dir, device="cpu", range_01=False, use_2dgs=True, selected_attr_list=None, return_gassians=False):
...
def denormalize_and_activate(attr, mv_image, range_01=False): # batchified
    # mv_image: B C H W, in range [-1,1]
    # if not range_01:
    # print("[denormalize_and_activate] range_01 is False, mapping to [0,1]")
