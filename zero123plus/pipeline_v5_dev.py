...
class RefOnlyNoisedUNet(torch.nn.Module):
    def __init__(self, unet: UNet2DConditionModel, train_sched: DDPMScheduler, val_sched: EulerAncestralDiscreteScheduler):
        # -> None:
        super().__init__()
        # self.unet = UNet2DConditionModelCrossDomainAttn(unet)
        self.unet = UNet2DConditionModelCrossDomainAttn()
        ...
        for name, _ in self.unet.unet.attn_processors.items():
            # print(name)
        ...
        self.unet.unet.set_attn_processor(unet_lora_attn_procs)
