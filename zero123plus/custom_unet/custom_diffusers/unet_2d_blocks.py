...
from zero123plus.custom_unet.custom_diffusers.transformer_mv2d import TransformerMV2DModel
from zero123plus.custom_unet.custom_diffusers.transformer_cd2d import Transformer2DCrossDomainModel
from diffusers.utils.torch_utils import apply_freeu


from diffusers.models.unet_2d_blocks import DownBlock2D, ResnetDownsampleBlock2D, AttnDownBlock2D, CrossAttnDownBlock2D, SimpleCrossAttnDownBlock2D, SkipDownBlock2D, AttnSkipDownBlock2D, AttnDownEncoderBlock2D, KDownBlock2D, KCrossAttnDownBlock2D
#  DownEncoderBlock2D, 
...
from diffusers.models.unet_2d_blocks import UNetMidBlock2DCrossAttn, UNetMidBlock2DSimpleCrossAttn, UNetMidBlock2D
...
def get_down_block(
    ...
    elif down_block_type == "CrossAttnDownBlockCrossDomain2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnDownBlockCrossDomain2D")
        return CrossAttnDownBlockCrossDomain2D(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
def get_up_block(
    ...
    if up_block_type == "UpBlock2D":
        ...
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlock2D")
        return CrossAttnUpBlock2D( # original 0123++
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
    ...
    elif up_block_type == "CrossAttnUpBlockCrossDomain2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlock2D")
        return CrossAttnUpBlockCrossDomain2D( # original 0123++
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
class CrossAttnDownBlockCrossDomain2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class CrossAttnUpBlockCrossDomain2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
    ...
    def forward(
        ...
        for resnet, attn in zip(self.resnets, self.attentions):
            ...
            # raise NotImplementedError # not use this for now
