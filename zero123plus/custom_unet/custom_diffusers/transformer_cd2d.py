...
from zero123plus.custom_unet.custom_diffusers.attention_cd2d import BasicTransformerCdBlock
...
class Transformer2DCrossDomainModel(ModelMixin, ConfigMixin):
    """
